...
// 	BouncePhase     string       `json:"bounce_phase"`
// 	Aborted         bool         `json:"aborted"`   //false
// 	Destroyed       bool         `json:"destroyed"` //false
// 	Raw             string       `json:"raw"`
// }
//
// type Account struct {
...
// 	IsScam   bool   `json:"is_scam"` //false
...
// 	DecodedBody   string   `json:"decoded_body"`
// }
//
